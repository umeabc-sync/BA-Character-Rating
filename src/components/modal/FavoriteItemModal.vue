      ...
      <div v-if="isVisible" class="favorite-item-modal-overlay" @click.self="closeModal">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            />
            <p class="item-name">
              <strong>{{ character.favoriteItem.name }}</strong>
            </p>
            <div class="info-row">
            ...
            <div class="effects">
              <p>
                <strong>{{ t('favoriteItemModal.t1Effect') }}</strong
                ><ColoredText :text="character.favoriteItem.effects[0]" :enabled="enableColoredText" />
              </p>
              <p>
                <strong>{{ t('favoriteItemModal.t2Effect') }}</strong
                ><ColoredText :text="character.favoriteItem.effects[1]" :enabled="enableColoredText" />
              </p>
            </div>
          </div>
        </div>
