<template>
  <div class="data-source-container">
    <a href="https://space.bilibili.com/35434465" target="_blank" rel="noopener noreferrer" :title="t('dataSource.title')">
...
/* Dark Mode */
.dark-mode .source-text { color: #98a6b3; }
.dark-mode .data-source-container a:hover img { filter: drop-shadow(0 4px 15px rgba(0, 174, 239, 0.4)); }
</style>